...
- <code title="post /checkouts">client.checkout_sessions_create(body: &amp;serde_json::Value) -&gt; Result&lt;CheckoutSessionResponse&gt;</code>
- <code title="get /checkouts/{id}">client.checkout_sessions_retrieve(id: &amp;str) -&gt; Result&lt;CheckoutSessionStatus&gt;</code>
- <code title="post /checkouts/preview">client.checkout_sessions_preview(body: &amp;serde_json::Value) -&gt; Result&lt;CheckoutSessionPreviewResponse&gt;</code>
...
- <code title="post /licenses/activate">client.licenses_activate(body: &amp;serde_json::Value) -&gt; Result&lt;LicenseActivateResponse&gt;</code>
- <code title="post /licenses/deactivate">client.licenses_deactivate(body: &amp;serde_json::Value) -&gt; Result&lt;()&gt;</code>
- <code title="post /licenses/validate">client.licenses_validate(body: &amp;serde_json::Value) -&gt; Result&lt;LicenseValidateResponse&gt;</code>
...
- <code title="post /brands">client.brands_create(body: &amp;serde_json::Value) -&gt; Result&lt;Brand&gt;</code>
- <code title="get /brands/{id}">client.brands_retrieve(id: &amp;str) -&gt; Result&lt;Brand&gt;</code>
- <code title="patch /brands/{id}">client.brands_update(id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;Brand&gt;</code>
...
- <code title="patch /webhooks/{webhook_id}/headers">client.webhooks_headers_update(webhook_id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;()&gt;</code>
...
- <code title="post /product-collections/{id}/groups">client.product_collections_groups_create(id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;ProductCollectionGroupResponse&gt;</code>
- <code title="patch /product-collections/{id}/groups/{group_id}">client.product_collections_groups_update(id: &amp;str, group_id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;()&gt;</code>
...
- <code title="post /product-collections/{id}/groups/{group_id}/items">client.product_collections_groups_items_create(id: &amp;str, group_id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;ItemCreateResponse&gt;</code>
- <code title="patch /product-collections/{id}/groups/{group_id}/items/{item_id}">client.product_collections_groups_items_update(id: &amp;str, group_id: &amp;str, item_id: &amp;str, body: &amp;serde_json::Value) -&gt; Result&lt;()&gt;</code>
